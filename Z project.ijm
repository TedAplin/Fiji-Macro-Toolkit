...
#@ String (label="Method for Z projection:", choices={"Max Intensity", "Average Intensity","Min Intensity","Sum Slices","Standard Deviation", "Median"}, style="listbox") Project //defines extension of files to be processed
